...
model.track(os.path.join(predict_dir, "Gabbia2-D6-eCig(1)-pre.mp4"), stream=True, stream_buffer=True ,save=True, save_txt=True, max_det=5, project=output_dir, name='test3_track-byteTrack', tracker="bytetrack.yaml")  # return a generator of Results objects
